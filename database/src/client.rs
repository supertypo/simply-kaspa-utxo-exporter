...
impl KaspaDbClient {
    ...
    pub async fn replace_script_utxo_counts(&self, script_utxo_counts: &[ScriptUtxoCount]) -> Result<u64, Error> {
        query::upsert::replace_script_utxo_counts(script_utxo_counts, &self.pool).await
    }
}
